...
This Repository will show Azure Machine Learning with Azure NetApp Files. For storage access, NFSv3 is used, but it can easily be switched to NFSv4.1.

The Azure Commands below incurs Azure expenses, hence delete all your Azure NetApp Files Capacity Pool and its associated resources and Volume after testing.
